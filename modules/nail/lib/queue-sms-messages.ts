export const AVG_SERVICE_MINUTES = 30;
...
export function queueJoinedSmsBody(opts: {
  ...
  if (position === 2) {
    return `Hi ${name}, you're #2 in the queue at ${shop}. Around 30 minutes until it's your turn.`;
  }
...
export function queueSmsBody(
  ...
  switch (template) {
    case "next":
      return `Hi ${name}, you'll be up next at ${shop}. Please head over — we'll call you when your station is ready.`;
    case "almost_next":
      return `Hi ${name}, you're now 2nd in the queue at ${shop}. Around 30 minutes until it's your turn — please stay nearby.`;
    case "ready":
      return `Hi ${name}, your technician is ready for you at ${shop}. Please take a seat now.`;
    case "running_late":
