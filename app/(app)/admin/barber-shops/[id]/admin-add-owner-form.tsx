...
import { adminAddBarberShopOwner, adminCreateBarberOwnerWithPassword } from "../actions";
...
export function AdminAddBarberOwnerForm({ shopId }: { shopId: string }) {
  ...
  async function handleCreateLogin(e: React.FormEvent) {
    ...
    const result = await adminCreateBarberOwnerWithPassword(
      shopId,
      createEmail,
      createPassword,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted mb-2">
          Set an email and password for your client. They can sign in at barbersynk.com/login
